...
# from kornia.classifier_augmentation.auto.operations.policy import PolicySequential
...
class UNetModel(nn.Module):
    ...
    def classify(self, x, t=None, augmentation=False):
        if t is None:
