...
def load_data(
    *,
    ...
    :param random_crop: if True, randomly crop the images for classifier_augmentation.
    :param random_flip: if True, randomly flip the images for classifier_augmentation.
    """
    if not data_dir:
