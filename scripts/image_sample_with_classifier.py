...
def main():
    ...
    while len(all_images)*args.batch_size < args.num_samples:
        ...
        for i in indices:
            ...
            loss = th.nn.CrossEntropyLoss(reduction="sum")(preds, target_class)
            loss.backward()
        ...
        if dist.get_rank() == 0:
            ...
            out_path = os.path.join(logger.get_dir(), f"samples_{args.model_path.split('/')[-1][:-3]}_with_classifier_lr_{args.sampling_lr}.npz")
